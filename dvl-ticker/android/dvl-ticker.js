      ...
      //var pfad_couchdb = "http://couchdb.volleyballserver.de/dvl2011/_design/lifeticker/_view/";
       pfad_couchdb = "http://couchdb.volleyballserver.de/dvl2011/_design/lifeticker/_view/";
...
$(".home_button_off").live('click',function () { 
	 ...
	 $(this).parent().parent().next().removeClass('versteckt');
...
$('#loading').live('pagecreate',function(event){
	window.setTimeout("$.mobile.changePage('#start', 'fade')", 5000);
